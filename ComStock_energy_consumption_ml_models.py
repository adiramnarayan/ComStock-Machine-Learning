...
# API_HDD_2018 and API_CDD_2018 must not be missinG
...
# Annual series must not exceed MAX_MISSING_HDD_CDD_FRAC -----
...
# report final performance on TEST set (touched exactly once) ----
